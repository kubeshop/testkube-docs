...
- Agent Metrics: Expanded Prometheus metrics for Test Workflows and Execution Steps. Workflow execution metrics now include additional fields (triggered_by, tags) for richer filtering and analysis, while new metrics for step-level duration and counts provide deeper visibility into execution details.
