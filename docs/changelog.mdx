...
- Fixes issues with artifact previews. Sometimes they were not rendering artifacts correctly.
- Fix newCredential is unknown function when creating a new Test Workflow template.
