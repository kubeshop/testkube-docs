...
You can also set **Environment Queue Limits** to prevent your workspace from getting overwhelmed. Once this limit is hit, executions will immediately abort which will also 
...
Read more: [Concurrency & Queueing](/articles/test-workflows-concurrency-queueing)
