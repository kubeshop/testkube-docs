...
- Added a new maxRole ceiling that lets you lock a member's effective permissions to read-only regardless of the roles they hold on individual environments or teams [read more](articles/members-manangement#read-access-controls)
