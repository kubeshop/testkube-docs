...
### What's new!
- Listener Agent: We have moved to a new capabilities system for the Testkube Agent. This allows newly created agents to register with a more granular set of capabilities (i.e. executing workflows, listening for trigger events)..
- Throttling: 
- Running context changes
- Filtering UI changes:
