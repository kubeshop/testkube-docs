...
Earlier this year, with the introduction of TestWorkflows, we announced our plan to deprecate legacy features including Tests, Suites, Executors, and Sources [see documentation on legacy features](https://docs.testkube.io/articles/legacy-features).
:::danger
...
This release includes PostgreSQL support in preview mode, which can be enabled through custom configuration.
