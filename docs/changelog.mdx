...
This release is packed with new functionality to manage the concurrency and reliability of executions. Define a Workflow Concurrency Policy to control the amount of executions that can run simultaneously across a single or a group of workflows.
