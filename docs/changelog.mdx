...
Starting with this release, we've consolidated the Control Plane and Agent versioning into a single unified version number.
Both components are now at v2.6.0, making it easier to track compatibility and understand which features are available across your Testkube deployment.
:::
