...
Starting in `v2.7`, orchestration ownership moves to the Control Plane by default:

- Control Plane: `CAPABILITY_SOURCE_OF_TRUTH=true`
- Agent: `WARNING_UNSAFE_FORCE_SUPERAGENT_MODE=false`
...
If you want Kubernetes manifests to remain authoritative for workflows, configure GitOps capability.
...
`TK_CLOUD_METRICS_ENABLED=true` is enabled by default in `v2.7`.
