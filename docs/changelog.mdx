...
- The release cadence will also be reduced to better fit enterprises. Moving forward you can expect a monthly minor release with some unplanned patch versions in between. The new process also improves predictable and stability of these releases.
