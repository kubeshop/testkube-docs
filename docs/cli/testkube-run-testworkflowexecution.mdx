...
```
  ...
  -h, --help                        help for testworkflowexecution
      --latest                      use the latest workflow definition instead of the original resolved snapshot, keeping the original parameter set
...
```
  ...
  -o, --output string           output type can be one of json|yaml|pretty|go (default "pretty")
      --skip-tls                skip TLS certificate verification for backend HTTPS connections
