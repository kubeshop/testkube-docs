...
When the generated JSON report is uploaded as an artifact, Testkube can detect it as an `artillery.report` report
and ingest aggregate counters, rates, summaries, and histograms as [Granular Metrics](../articles/granular-metrics).
