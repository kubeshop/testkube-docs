...
- _"Triage the latest failed execution of my-api-tests"_
- _"Is execution abc123 an infrastructure failure or a test bug?"_
- _"Check all failures from the last hour — how many are infra vs test?"_
