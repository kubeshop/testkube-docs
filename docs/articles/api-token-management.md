...
API Tokens are created under the Organization Settings [API Tokens tab](/articles/organization-management#api-tokens)
...
:::info
Check out [Connecting from the CLI](/articles/managing-cli-context) to learn how to use an API token with the CLI.
:::
