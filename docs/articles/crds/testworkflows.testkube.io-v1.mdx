...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `group` _string_ | Group ongoing executions by this identifier instead of by workflow name.<br />Use the group identifier if you want the control concurrency across workflows |  |  |
| `max` _integer_ | The maximum amount of concurrent executions for this workflow or group.<br />The scheduler will check the amount of ongoing executions for this workflow or group and only<br />schedule this workflow when the amount is below its given maximum. When using a group identifier, it is<br />recommended to keep the maximum in sync through a WorkflowTemplate. |  |  |
| `cancelInProgress` _boolean_ | Whether the oldest in progress execution should be cancelled to be replaced with the latest queued one. |  |  |
...
| `securityContext` _[WorkflowSecurityContext](#workflowsecuritycontext)_ | security context for the container |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `id` _string_ | stable identifier for referencing this step in expressions (e.g., step.&lt;id&gt;.outputs)<br />if not provided, auto-derived from name by lowercasing and replacing non-alphanumeric characters with underscores<br />must contain only lowercase alphanumeric characters and underscores |  |  |
...
| `securityContext` _[WorkflowPodSecurityContext](#workflowpodsecuritycontext)_ | SecurityContext holds pod-level security attributes and common container settings. |  |  |
| `disableFsGroupDefaulting` _boolean_ | disable automatic pod fsGroup inference/defaulting; explicit securityContext.fsGroup still applies |  |  |
...
| `variables` _object (keys:string, values:Variable)_ |  |  |  |
...
| `envConfigMaps` _EnvReference array_ | config map references |  |  |
| `envSecrets` _EnvReference array_ | secret references |  |  |
...
| `tags` _object (keys:string, values:string)_ | test workflow execution tags |  |  |
| `target` _[Target](#target)_ | Targets helps decide on which runner the execution is scheduled. |  |  |
| `silent` _boolean_ | When true, SilentMode is activated for all executions (Webhooks, Insights, Health, Metrics, Cdevents all set to true). |  |  |
...
| `pod` _[PodConfig](#podconfig)_ | configuration for the scheduled pod |  |  |
| `concurrency` _[ConcurrencyPolicy](#concurrencypolicy)_ | configuration for concurrency policy |  |  |
...
| `execution` _[TestWorkflowExecutionSchema](#testworkflowexecutionschema)_ | values to be used for test workflow execution |  |  |
| `timeouts` _[TestWorkflowTimeouts](#testworkflowtimeouts)_ | per-workflow timeout configuration |  |  |
| `services` _object (keys:string, values:[ServiceSpec](#servicespec))_ | list of accompanying services to start |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `queue` _string_ | maximum time the execution may spend in queue before starting |  |  |
| `initialization` _string_ | maximum time for initialization/transitioning before steps run |  |  |


### WorkflowInt64OrString
...
_Appears in:_
- [WorkflowPodSecurityContext](#workflowpodsecuritycontext)
- [WorkflowSecurityContext](#workflowsecuritycontext)



### WorkflowPodSecurityContext
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `seLinuxOptions` _[SELinuxOptions](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#selinuxoptions-v1-core)_ |  |  |  |
| `windowsOptions` _[WindowsSecurityContextOptions](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#windowssecuritycontextoptions-v1-core)_ |  |  |  |
| `runAsUser` _[WorkflowInt64OrString](#workflowint64orstring)_ |  |  | XIntOrString: \{\} <br /> |
| `runAsGroup` _[WorkflowInt64OrString](#workflowint64orstring)_ |  |  | XIntOrString: \{\} <br /> |
| `runAsNonRoot` _boolean_ |  |  |  |
| `supplementalGroups` _integer array_ |  |  |  |
| `supplementalGroupsPolicy` _[SupplementalGroupsPolicy](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#supplementalgroupspolicy-v1-core)_ |  |  |  |
| `fsGroup` _[WorkflowInt64OrString](#workflowint64orstring)_ |  |  | XIntOrString: \{\} <br /> |
| `sysctls` _[Sysctl](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#sysctl-v1-core) array_ |  |  |  |
| `fsGroupChangePolicy` _[PodFSGroupChangePolicy](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#podfsgroupchangepolicy-v1-core)_ |  |  |  |
| `seccompProfile` _[SeccompProfile](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#seccompprofile-v1-core)_ |  |  |  |
| `appArmorProfile` _[AppArmorProfile](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#apparmorprofile-v1-core)_ |  |  |  |
| `seLinuxChangePolicy` _[PodSELinuxChangePolicy](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#podselinuxchangepolicy-v1-core)_ |  |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `capabilities` _[Capabilities](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#capabilities-v1-core)_ |  |  |  |
...
| `procMount` _[ProcMountType](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#procmounttype-v1-core)_ |  |  |  |
| `seccompProfile` _[SeccompProfile](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#seccompprofile-v1-core)_ |  |  |  |
| `appArmorProfile` _[AppArmorProfile](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#apparmorprofile-v1-core)_ |  |  |  |
...
_Appears in:_
- [WorkflowTriggerWaitConditions](#workflowtriggerwaitconditions)

| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `type` _string_ | Type is the condition type (e.g. Available, Ready). |  |  |
| `status` _[WorkflowTriggerConditionStatus](#workflowtriggerconditionstatus)_ | Status is the expected condition status. |  | Enum: [True False Unknown] <br /> |
| `reason` _string_ | Reason is the expected condition reason. Optional. |  |  |
| `ttl` _integer_ | TTL is the maximum age in seconds for the condition to be considered valid. |  |  |


### WorkflowTriggerConditionStatus
...
_Appears in:_
- [WorkflowTriggerCondition](#workflowtriggercondition)
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `path` _string_ | Path is a dot-path to a field on the K8s object, e.g. ".spec.replicas",<br />".spec.template.spec.containers.0.image". Array elements use .N syntax. |  |  |
| `operator` _[WorkflowTriggerFieldOperator](#workflowtriggerfieldoperator)_ | Operator is the comparison operator. |  | Enum: [equals not_equals exists not_exists changed changed_to changed_from] <br /> |
| `value` _string_ | Value to compare against. Required for equals, not_equals, changed_to, changed_from. |  |  |


### WorkflowTriggerFieldOperator
...
_Validation:_
- Enum: [equals not_equals exists not_exists changed changed_to changed_from]

_Appears in:_
- [WorkflowTriggerFieldCondition](#workflowtriggerfieldcondition)
...
_Appears in:_
- [WorkflowTriggerWaitProbes](#workflowtriggerwaitprobes)

| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `scheme` _string_ | Scheme is the probe scheme (http or https). Default: http. |  |  |
| `host` _string_ | Host is the probe host. Default: pod IP or service name. |  |  |
| `path` _string_ | Path is the probe path. Default: /. |  |  |
| `port` _integer_ | Port is the probe port. |  |  |
| `headers` _object (keys:string, values:string)_ | Headers are HTTP headers to send with the probe. |  |  |
...
_Appears in:_
- [WorkflowTriggerWatch](#workflowtriggerwatch)

| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `group` _string_ | Group is the API group (empty for core resources like Pod, Service, ConfigMap). |  |  |
| `version` _string_ | Version is the API version. Optional for well-known types. |  |  |
| `kind` _string_ | Kind is the resource kind (e.g. Deployment, KafkaTopic). Required. |  |  |
| `name` _string_ | Name matches the resource by exact name. |  |  |
| `namespace` _string_ | Namespace matches the resource by exact namespace. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `workflow` _[WorkflowTriggerWorkflowSelector](#workflowtriggerworkflowselector)_ | Workflow identifies which workflow(s) to execute. |  |  |
| `target` _[Target](#target)_ | Target defines runner targeting (match/not/replicate). |  |  |
| `parameters` _[WorkflowTriggerRunParameters](#workflowtriggerrunparameters)_ | Parameters defines config values and tags passed to the workflow.<br />Config values support the Testkube expression language: \{\{resource.spec.replicas\}\} |  |  |
| `concurrencyPolicy` _string_ | ConcurrencyPolicy defines how concurrent executions are handled. |  | Enum: [allow forbid replace] <br /> |
| `delay` _[Duration](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#duration-v1-meta)_ | Delay is the duration to wait before executing. |  | Format: duration <br />Type: string <br /> |


### WorkflowTriggerRunParameters
...
_Appears in:_
- [WorkflowTriggerRun](#workflowtriggerrun)

| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `config` _object (keys:string, values:string)_ | Config maps config variable names to values or expressions. |  |  |
| `tags` _object (keys:string, values:string)_ | Tags maps tag names to values or expressions. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `nameRegex` _string_ | NameRegex matches the resource name by regex. |  |  |
| `namespaceRegex` _string_ | NamespaceRegex matches the resource namespace by regex. |  |  |
| `labelSelector` _[LabelSelector](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#labelselector-v1-meta)_ | LabelSelector matches resources by K8s label selector. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[WorkflowTriggerWaitConditions](#workflowtriggerwaitconditions)_ | Conditions defines K8s resource conditions to wait for. |  |  |
| `probes` _[WorkflowTriggerWaitProbes](#workflowtriggerwaitprobes)_ | Probes defines HTTP health checks to wait for. |  |  |


### WorkflowTriggerWaitConditions
...
_Appears in:_
- [WorkflowTriggerWait](#workflowtriggerwait)

| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `items` _[WorkflowTriggerCondition](#workflowtriggercondition) array_ | Items is the list of conditions to match. |  |  |
| `timeout` _integer_ | Timeout is the maximum time in seconds to wait for conditions. |  |  |
| `delay` _integer_ | Delay is the time in seconds between condition checks. |  |  |


### WorkflowTriggerWaitProbes
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `items` _[WorkflowTriggerProbe](#workflowtriggerprobe) array_ | Items is the list of probes to check. |  |  |
| `timeout` _integer_ | Timeout is the maximum time in seconds to wait for probes. |  |  |
| `delay` _integer_ | Delay is the time in seconds between probe checks. |  |  |


### WorkflowTriggerWatch
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `resource` _[WorkflowTriggerResource](#workflowtriggerresource)_ | Resource identifies the K8s resource by Group/Version/Kind.<br />Group and Version are optional for well-known types (resolved via discovery API). |  |  |
| `selector` _[WorkflowTriggerSelector](#workflowtriggerselector)_ | Selector provides advanced resource filtering (regex, labels). |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `event` _string_ | Event is the K8s resource event type. Required when no other trigger source<br />(schedule, webhook, etc.) is configured. Validated at application level. |  | Enum: [created modified deleted] <br /> |


### WorkflowTriggerWorkflowSelector
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `name` _string_ | Name matches a workflow by exact name. |  |  |
| `nameRegex` _string_ | NameRegex matches workflows by name regex. |  |  |
| `labelSelector` _[LabelSelector](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#labelselector-v1-meta)_ | LabelSelector matches workflows by K8s label selector. |  |  |
