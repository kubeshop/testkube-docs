...
| `valueFrom` _[EnvVarSource](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#envvarsource-v1-core)_ | Source for the environment variable's value. Cannot be used if value is not empty. |  |  |
...
| `pvcs` _object (keys:string, values:[PersistentVolumeClaimSpec](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#persistentvolumeclaimspec-v1-core))_ | list of accompanying permanent volume claims |  |  |
...
| `selector` _[LabelSelector](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#labelselector-v1-meta)_ | selector is used to identify a group of test workflows based on their metadata labels |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `seLinuxOptions` _[SELinuxOptions](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#selinuxoptions-v1-core)_ |  |  |  |
| `windowsOptions` _[WindowsSecurityContextOptions](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#windowssecuritycontextoptions-v1-core)_ |  |  |  |
...
| `supplementalGroupsPolicy` _[SupplementalGroupsPolicy](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#supplementalgroupspolicy-v1-core)_ |  |  |  |
| `fsGroup` _[WorkflowInt64OrString](#workflowint64orstring)_ |  |  | XIntOrString: \{\} <br /> |
| `sysctls` _[Sysctl](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#sysctl-v1-core) array_ |  |  |  |
| `fsGroupChangePolicy` _[PodFSGroupChangePolicy](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#podfsgroupchangepolicy-v1-core)_ |  |  |  |
| `seccompProfile` _[SeccompProfile](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#seccompprofile-v1-core)_ |  |  |  |
| `appArmorProfile` _[AppArmorProfile](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#apparmorprofile-v1-core)_ |  |  |  |
| `seLinuxChangePolicy` _[PodSELinuxChangePolicy](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#podselinuxchangepolicy-v1-core)_ |  |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `capabilities` _[Capabilities](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#capabilities-v1-core)_ |  |  |  |
...
| `procMount` _[ProcMountType](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#procmounttype-v1-core)_ |  |  |  |
| `seccompProfile` _[SeccompProfile](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#seccompprofile-v1-core)_ |  |  |  |
| `appArmorProfile` _[AppArmorProfile](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#apparmorprofile-v1-core)_ |  |  |  |
...
| `delay` _[Duration](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#duration-v1-meta)_ | Delay is the duration to wait before executing. |  | Format: duration <br />Type: string <br /> |
...
| `labelSelector` _[LabelSelector](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#labelselector-v1-meta)_ | LabelSelector matches resources by K8s label selector. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `watch` _[WorkflowTriggerWatch](#workflowtriggerwatch)_ | Watch defines which K8s resource to observe. Optional for non-K8s trigger sources. |  |  |
| `when` _[WorkflowTriggerWhen](#workflowtriggerwhen)_ | When defines the trigger source. |  |  |
| `match` _[WorkflowTriggerFieldCondition](#workflowtriggerfieldcondition) array_ | Match defines field-level conditions using JSONPath. All conditions must pass (AND logic). |  |  |
| `wait` _[WorkflowTriggerWait](#workflowtriggerwait)_ | Wait defines stability gates that must pass before execution. |  |  |
| `run` _[WorkflowTriggerRun](#workflowtriggerrun)_ | Run defines what workflow to execute and how. |  |  |
| `disabled` _boolean_ | Disabled disables the trigger without deleting it. |  |  |
...
| `labelSelector` _[LabelSelector](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#labelselector-v1-meta)_ | LabelSelector matches workflows by K8s label selector. |  |  |
