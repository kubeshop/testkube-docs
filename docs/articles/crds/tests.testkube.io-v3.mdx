...
| `github` | GitAuthTypeGitHub for GitHub App auth requests<br /> |
...
| `authType` _[GitAuthType](#gitauthtype)_ | auth type for git requests |  | Enum: [basic header github] <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `latestExecution` _[ExecutionCore](#executioncore)_ | latest execution result |  |  |
...
_Appears in:_
- [TestSuiteExecutionCore](#testsuiteexecutioncore)
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `latestExecution` _[TestSuiteExecutionCore](#testsuiteexecutioncore)_ | latest execution result |  |  |
