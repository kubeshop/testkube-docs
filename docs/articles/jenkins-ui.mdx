...
To use Jenkins CI/CD with [Testkube](https://app.testkube.io/), you need to create an [API token](https://docs.testkube.io/testkube-pro/articles/organization-management/#api-tokens).

### How to set up a Freestyle Project to run Test Workflow on Testkube
...
5. Add a new "Execute Shell" Build Step and run one or multiple Testkube CLI commands such as:
<!-- ![jenkins execute shell](../img/jenkins-execute-shell.png) Commented this because image shows deprecated commands. Please take updated screenshots.
Adding updated command as code block for now-->
