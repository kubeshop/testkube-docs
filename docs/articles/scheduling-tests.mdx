...
:::info
In connected environments from `v2.7`, schedule ownership is handled by the Control Plane by default.
See [Control Plane Source of Truth](/articles/control-plane-source-of-truth#scheduling-changes).
:::
