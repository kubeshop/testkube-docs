...
- List existents: `kubectl get webhooktemplates -n <namespace>`{:.bash}
- Create new: `kubectl apply -f <webhook-template-manifest-file>.yaml -n <namespace>`{:.bash}
- Edit one: `kubectl edit webhooktemplates <name-of-webhook-template> -n <namespace>`{:.bash}
- Delete: `kubectl delete webhooktemplates <name-of-webhook-template> -n <namespace>`{:.bash}
