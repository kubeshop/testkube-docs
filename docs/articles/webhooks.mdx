...
spec:
  ...
  headers:
    Authorization: "Basic {{ index .Config \"apitoken\" }}"
```
...
WebhookTemplate can be used only as a part of the calling Webhook. It's content is merged into the Webhook specification.
