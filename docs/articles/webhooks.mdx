...
:::info
In connected environments from `v2.7`, webhooks continue to be executed by Agents while the Control Plane becomes the default source of orchestration truth.
See [Control Plane Source of Truth](/articles/control-plane-source-of-truth#webhooks-and-triggers).
:::
