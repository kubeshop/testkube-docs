...
Kubernetes cluster is the Testkube Agent with 
[Testkube CRDs](crds).

To install Testkube CRDs into your local cluster, checkout the [testkube](https://github.com/kubeshop/testkube) project and run:
