...
Requires both the Control Plane and the Runner agent on version **2.14 or later**. Older runners can render incomplete data in the Running Context and the Resource Usage chart of child executions triggered through the integration. Bump the agent version if either component is behind.
:::
