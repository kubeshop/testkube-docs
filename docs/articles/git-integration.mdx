...
{/* @screenshot: /img/git-integration/overview.png dashboard Integrations, GitHub, repository list with one connected repository */}
...
{/* @screenshot: /img/git-integration/install-app-empty-state.png dashboard empty state with the "Connect my first repository" call to action */}
...
{/* @screenshot: /img/git-integration/github-app-install.png GitHub's App installation screen showing the org picker and repository access selector */}
...
{/* @screenshot: /img/git-integration/connect-repository-picker.png Connect repository wizard, workflow selection step listing existing Workflows in the environment */}
...
{/* @screenshot: /img/git-integration/connect-repository-scan.png scan result showing detected frameworks with checkboxes to review */}
...
{/* @screenshot: /img/git-integration/event-triggers-panel.png repository Configuration tab, event-triggers section with the pull_request, push, tag, release, issue_comment toggles */}
...
{/* @screenshot: /img/git-integration/pr-comment-condensed.png Condensed PR comment as it renders on GitHub */}

![Condensed PR comment posted by the Testkube integration](../img/git-integration/pr-comment-condensed.png)

{/* @screenshot: /img/git-integration/pr-comment-detailed.png Detailed PR comment side-by-side or below the Condensed one, phase breakdown expanded */}
...
{/* @screenshot: /img/git-integration/check-run-blocked.png GitHub PR with the aggregate Testkube check-run marked failed and the Merge button blocked by branch protection */}
...
{/* @screenshot: /img/git-integration/ai-summary-config.png Configuration panel AI Summary section with agent, model, and Run when controls */}
...
{/* @screenshot: /img/git-integration/ai-session-pr-link.png PR comment scrolled to the AI Analysis block with the "Continue analysis in Testkube" link highlighted */}

![Detailed PR comment with the "Continue analysis in Testkube" link highlighted](../img/git-integration/ai-session-pr-link.png)

{/* @screenshot: /img/git-integration/ai-session-chat.png the AI chat view in Testkube after landing from the PR link, showing the running conversation */}

## Auto-generated Workflows

{/* @screenshot: /img/git-integration/auto-gen-workflows-list.png repository Workflows tab listing the auto-gen Workflows with their framework badges */}
...
{/* @screenshot: /img/git-integration/executions-filter-chip.png Executions list with the Git Integration filter chip applied, results scoped to gitintegration actor */}
...
{/* @screenshot: /img/git-integration/pr-check-run-passed.png PR Checks tab showing the aggregate Testkube check-run passing, with per-Workflow rows underneath */}

![PR Checks tab with the Testkube check-run passing](../img/git-integration/pr-check-run-passed.png)

{/* @screenshot: /img/git-integration/pr-check-run-failed.png the same view with a failed Workflow so the aggregate is red and the failure surfaces */}
