...
Requires both the Control Plane and the Runner agent on version **2.13.1 or later**. Older runners can render incomplete data in the Running Context and the Resource Usage chart of child executions triggered through the integration.
:::
