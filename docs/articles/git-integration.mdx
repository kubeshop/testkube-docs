...
:::warning Keep the agent up to date
Run the Control Plane and the Runner agent on the [latest Testkube release](https://github.com/kubeshop/testkube/releases). Older runners can render incomplete data in the Running Context and the Resource Usage chart of child executions triggered through the integration.
:::
