...
To use this GitHub Action for the [Testkube Pro](https://app.testkube.io/), you need to create
 an [API token](https://docs.testkube.io/testkube-pro/articles/organization-management/#api-tokens).
...
You can also specify a particular Testkube CLI or API version (don't confuse it with the Helm chart one), if it's omitted, then latest version is used.
The list of [releases] (https://github.com/kubeshop/testkube/releases) can be found in Testkube Github repository.
