...
Testkube introduces **Workflow Health** as a core metric to help you evaluate the _reliability_ and _stability_ of your Test Workflows over time.
...
![Workflow Health in Dashboard](images/workflow-health-in-dashboard.png)
