...
You can get the required tokens from the [Standalone Agent Panel](/articles/agents-overview#managing-the-standalone-agent).
...
[Standalone Agent Settings](/articles/agents-overview#managing-the-standalone-agent) popup.
