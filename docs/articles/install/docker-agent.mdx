...
right amount of resources to your Docker Engine for the kinds of Tests you plan to run. We recommend at least
...
Kubernetes instance, either locally as described below, or in a remote/hosted Kubernetes provider in line with the
