...
to [request your free trial license](https://testkube.io/download) that will be needed during the installation process.
...
:::info
Why is a license is required? Obtaining a license helps us ensure you have an optimal installation and product experience with Testkube. Don’t worry - you won’t have to talk to a sales rep or enter any credit-card details to get going - but if you need our help we’ll be much better prepared!
:::
...
To install the Testkube CLI you'll need the following tools:
