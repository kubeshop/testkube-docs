...
Kubernetes distribution under Docker, or use the [Testkube Docker Agent](/articles/install/docker-agent).
...
Docker to be installed, so make sure that is up and running before moving on (download Docker Desktop from https://www.docker.com/products/docker-desktop/).
...
[install-with-cli]: /articles/tutorial/quickstart/individual-evaluation
