...
When using the Testkube Cloud Control Plane (available at https://app.testkube.io), the Control Plane is managed by the Testkube team, you only have to install the
