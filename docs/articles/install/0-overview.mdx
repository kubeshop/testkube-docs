...
| Deployment Option                | Testkube Agent | Testkube Control Plane | Testkube Dashboard | Testkube CLI |
|----------------------------------|:--------------:|:----------------------:|:------------------:|:------------:|
| **Testkube On-Prem**             | Hosted by you  |     Hosted by you      |         ✅          |      ✅       |
| **Testkube Cloud Control Plane** | Hosted by you  |   Hosted by Testkube   |         ✅          |      ✅       |
| **Testkube Standalone Agent**    | Hosted by you  |           ❌            |         ❌          |      ✅       |
