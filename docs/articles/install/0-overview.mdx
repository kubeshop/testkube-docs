...
1. The **Testkube Control Plane**, which includes the [Dashboard](/articles/testkube-dashboard-explore), Storage for Resources/Results/Logs/Artifacts, Scheduling, User/Role mgmt, Insights, 3rd party integrations, etc. - [Read More](/articles/testkube-resource-management)
