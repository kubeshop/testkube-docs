...
1. Enter a **Search** criterion. <br>
   **Save as view** becomes visible.
1. Click **Add a filter** to enter one or more filters.
   ![Custom Views](../articles/images/testkube-dashboard-custom-views-filter.png)
1. Click **Save as view**. <br>
   **Save new view** opens – allowing you to designate your view parameters.
   ![Custom Views](../articles/images/testkube-dashboard-custom-views-save-view.png)
1. Enter information in the **Name**, **Description**, and **Visibility** fields.
   ![Custom Views](../articles/images/testkube-dashboard-custom-views-criteria.png)
1. Click **Save**. <br>
   The view becomes visible in the left navigation pane and associated with the **Visibility** you designated.
   ![Custom Views](../articles/images/testkube-dashboard-custom-views-navpane.png)
1. Perform and save another view, changing **Visibility** to **Shared across environment**.<br>
