...
- **Git Token** / **Git Username** – Allows you to choose **Secret Reference**, **Secret**, **Plain-Text**, **Credential**, or **Credential Reference**.
  ...
  - **Credential** – Testkube automatically creates a credential for the specified value.
  - **Credential Reference** – Allows you to enter the credential reference to an existing credential.
...
Select the **Inline template definitions** checkbox to _inline_ any used templates into the generated YAML.
