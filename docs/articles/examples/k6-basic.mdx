...
- The k6 command exports `summary.json`, which Testkube can ingest as [performance metrics](/articles/performance-metrics-in-insights).
...
![HTML Report](images/k6-basic-html-report.png)
