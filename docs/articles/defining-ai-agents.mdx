...
allow the AI Agent to use the tool without approval. Disable this setting to require approval of this tool - you will 
be prompted for approval in the Chat Session panel as the Chat is performed.
