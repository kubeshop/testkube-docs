...
- Automating the [Testkube CLI](/articles/install/cli) in your CI/CD tool
...
The Workflow Details tab in the Testkube Dashboard shows you preconfigured configurations for popular CI/CD tools
