...
A Remediation AI Agent in Testkube can be tasked to automatically identify, and in the best scenario, fix issues related to failing tests. 
...
## Basic Example using the GitHub

The following example AI Agent expects the code changes to be in a GitHub repository and uses
the GitHub MCP Server to create a pull request with the suggested fix.
...
![Remediation GitHub Authorization](remediation-github-auth.png)
...
what you want and set the prompt to the following:
...
![Remediation GitHub MCP Server Tools](remediation-github-mcp-tools.png)
...
the "AI Analyze" button is available. Click the button and select the AI Agent you created: 

![Remediation AI Analyze](remediation-ai-analyze.png)
...
![Remediation Chat Panel](remediation-chat-panel.png)
...
![Remediation Tool Approval](remediation-tool-approval.png)
...
![Remediation Result](remediation-result.png)
