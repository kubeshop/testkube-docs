...
A Remediation AI Agent in Testkube can be tasked to automatically identify, and in the best scenario, fix code or configuration issues related to failing tests. 
...
## Basic Remediation Agent using GitHub
