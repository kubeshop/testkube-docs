...
Please take into account that timeout includes all time starting from creation of the kubernetes pod, scheduling on the node, pulling the image and waiting it reading and executing the test request against it.
