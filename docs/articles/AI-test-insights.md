...
Selecting this will open a new AI chat with a prompt to analyze the failed Workflow Execution:

![AI Analyze prompt in AI Chat](images/ai-analyze-in-ai-assistant.png)

:::tip
You could of course enter the same prompt manually in any chat and for any execution, not just failed ones.
:::
