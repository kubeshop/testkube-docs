...
command within a Tekton pipeline.The integration offers a versatile approach to align with your pipeline requirements and is compatible with Testkube Pro, 
Testkube Pro On-Prem, and the open-source Testkube platform. It enables Tekton users to leverage the powerful features of Testkube directly within their
  CI/CD pipelines, ensuring efficient and flexible Test Workflow execution.

## Pre-requisites

* [Testkube Pro](https://app.testkube.io/)
* Kubernetes cluster
* Configure [Testkube Agent](http://docs.testkube.io/testkube-cloud/articles/installing-agent) on the cluster
* Install [Tekton Pipeline](https://tekton.dev/docs/installation/pipelines/#installation) on the cluster

## How to configure Testkube CLI for Testkube Pro and run a Test Workflow

To use this Tekton for [Testkube Pro](https://app.testkube.io/), you need to create an [API token](https://docs.testkube.io/testkube-pro/articles/organization-management/#api-tokens).
