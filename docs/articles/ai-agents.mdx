...
Testkube includes a set of pre-defined Guidance AI Agents in the Dashboard that you can easily add to your environment 
and use to get started with AI Agents - read more at [Creating an AI Agent from a Template](/articles/defining-ai-agents#creating-an-ai-agent-from-a-template).

![AI Agent Templates](images/ai-agent-templates.png)
