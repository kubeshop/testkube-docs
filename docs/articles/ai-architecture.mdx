...
:::note
The LLM used by AI Agents and the AI Assistant is configurable. See [Default LLM and Model](/articles/ai-assistant-enable#default-llm-and-model) 
...
Conversation state is stored in a PostgreSQL database, ensuring:
...
For detailed security information, see [AI Assistant Security & Compliance](/articles/ai-assistant-security).
...
- [MCP Configuration](/articles/mcp-configuration)
