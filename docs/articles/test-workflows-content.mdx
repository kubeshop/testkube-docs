...
- content:
    git:
      uri: https://github.com/kubeshop/helm-charts
      mountPath: /helm-charts
  # highlight-start
  # NOTE: Cloned data only available for these nested steps
  steps:
  - shell: ls -lah /data/repo && ls -lah /helm-charts
  # highlight-end
```
  ...
  - name: Load common repositories
    run:
      ...
      shell: |
        ...
        git clone --depth 1 https://github.com/kubeshop/helm-charts /repos/helm-charts
  - shell: tree /repos
```
  ...
  - name: Load common repositories
    run:
      ...
      shell: |
        ...
        git clone --depth 1 https://github.com/kubeshop/helm-charts /data/repos/helm-charts
