...
By default it uses no-cone mode (so file paths needs to be passed as [**full pattern set**](https://git-scm.com/docs/git-sparse-checkout#_internalsfull_pattern_set)).
To use cone mode and interpret file patterns in a ([**cone pattern set**](https://git-scm.com/docs/git-sparse-checkout#_internalscone_pattern_set)),
