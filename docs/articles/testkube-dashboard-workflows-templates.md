...
With a standard set of instructions for testing tools, you do not have to start your test instructions with a _blank page_ of sorts. Instead, you can start with a **Workflow Template** –
