...
There are various ways to run your end-to-end tests:

- You can create preview environments outside of Testkube.
- You can use [TestWorkflow services][tw-services] to spawn your test dependencies.
...
<TabItem value="services" label="With workflow services">
...
[tw-services]: /articles/test-workflows-examples-services
