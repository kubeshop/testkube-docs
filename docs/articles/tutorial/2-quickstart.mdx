...
- If you are looking to share Testkube with your team, then we recommend using the Cloud Control Plane, or [deploying an On-Prem Control Plane via Helm](https://docs.testkube.io/articles/install/install-with-helm) to a cluster which your team, or partner DevOps team, can manage. If you self host, we recommend deploying the Agent and Control Plane to the same cluster and namespace, unless your use case requires otherwise.
:::
