...
:::info
Need more details or customization? You can learn more in [our installating documentation][testkube-installing].
:::
...
spec:
  ...
  # All steps share the file system and can run a specific images.
  steps:
...
we can already go ahead and try to run this workflow.
...
1. Browse to your triggers within the left sidebar
...
To learn how to do this we recommend you to either:
