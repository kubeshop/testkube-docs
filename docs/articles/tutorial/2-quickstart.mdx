...
- Learn more about deployments in [deployment architectures](/articles/install/deployment-architectures)

<Tabs groupId="tutorial-install-cli">
<TabItem value="cloud" label="Testkube Cloud" default>

1. Login to [Testkube Cloud](https://app.testkube.io).
...
2. Request a free license at https://testkube.io/download.
...
<TabItem value="demo" label="Testkube Demo Environment">
...
different testing tools, with corresponding execution results and Test Insights.

Please note though that the Demo Environment won't allow you to follow the steps further down in the quickstart since
those require your own environment.
:::

  1. Login to [Testkube Cloud](https://app.testkube.io).
  2. Once authenticated, [go to the demo environment.](https://app.testkube.io/demo-environment)
  3. Alternatively, you can access the demo environment from multiple places throughout the app, for example when
  [Creating an Environment](/testkube-pro/articles/environment-management#creating-a-new-environment):
...
## 5. Integrate within your CI/CD Pipelines

Workflow execution can be integrated in your CI pipelines, run on a cron schedule or trigger on a Kubernetes event.
...
:::tip
Testkube currently shows instructions for GitHub Actions, GitLab CI, CircleCI, Jenkins and Azure DevOps, but can
