...
:::info
Need more details or customization? You can learn more in [our installation documentation][testkube-installing].
:::
...
1. Login to Testkube.
2. Click the `Get access to a demo environment` or the `See a live sandbox of dashboard` button, in their respective views.
