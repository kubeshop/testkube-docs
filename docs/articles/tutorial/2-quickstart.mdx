...
- If you are looking to evaluate Testkube before sharing it with others, we recommend using the [Evaluation Install](https://docs.testkube.io/articles/install/install-with-cli). This runs on your local machine, and is deployed into a pre-existing light-weight Kubernetes distribution (like [minikube](https://minikube.sigs.k8s.io/docs/)). This guide assumes an Evaluation Installation.
