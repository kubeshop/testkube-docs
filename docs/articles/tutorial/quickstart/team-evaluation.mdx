...
_For more information on baseline configuration of the Testkube Control Plane deployment, please visit [our base installation documentation ][base-install]_
