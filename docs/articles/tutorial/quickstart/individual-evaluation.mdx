...
This step-by-step tutorial provides you with a simplified Testkube On Prem installation that deploys the Testkube Control Plane
...
A trial license will be required during installation - **[schedule time with our Solutions Engineering team](https://testkube.io/demo)** to get your license and 
...
- Install Testkube's Control Plane.
- If you want to run workflows in this demo, install a Testkube Runner separately using the `testkube install runner` flow.
...
:::info
In case of issues with the license, please try `testkube diag license` command for license validation.
:::
