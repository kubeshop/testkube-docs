...
The control plane now comes with public changelogs and a unified version.
...
The release cadence will also be reduced to better fit enterprises and make changes more predictable.
Moving forward you can expect a monthly minor release with some unplanned patch versions in between.
The stability of these releases will be better moving forward.
